...
import com.himanshuahuja.movieapp.adapter.TrailerAdapter;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void loadJSON(){
            ...
            Call<TrailerResponse> call = apiService.getMovieTrailer(movie_id,getResources().getString(R.string.MOVIE_DB_API_KEY));
